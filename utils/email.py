...
def _send(to_email: str, subject: str, html: str) -> bool:
    gmail, app_password = _get_credentials()
...
def send_missed_medication_alert(to_email, caregiver_name, patient_name, medication_name, scheduled_time):
    ...
    <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #444;">Hi {caregiver_name},</p>
      <p style="color: #444;">
        <strong>{patient_name}</strong> has not confirmed taking
        <strong>{medication_name}</strong> scheduled for <strong>{scheduled_time}</strong>.
      </p>
      <div style="background: #fdf3f3; border-left: 4px solid #c0392b; padding: 16px; border-radius: 4px; margin: 20px 0;">
        ...
        <p style="margin: 8px 0 0; color: #555; font-size: 14px;">
          Please check in with {patient_name} to ensure they take their medication.
        </p>
      </div>
      <p style="color: #999; font-size: 12px; margin-top: 32px;">— MedAlly</p>
    </div>
    """
...
def send_welcome_email(to_email: str, name: str):
    ...
    <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #444;">You're all set. Add your family members and their medications.</p>
      <p style="color: #444;">We'll alert you if anyone misses a dose.</p>
      <p style="color: #999; font-size: 12px; margin-top: 32px;">— The MedAlly team</p>
    </div>
    """
